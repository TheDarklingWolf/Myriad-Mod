...
t_lava,
// Crops
t_wheatseed, t_wheatsprout, t_wheat,
t_potatoseed, t_potatosprout, t_potato,
// Embellishments
t_bed, t_crap_bed, t_toilet,
...
{"pit",              '0', c_brown,  10, tr_pit,
	mfb(transparent)|mfb(diggable)},
{"covered pit",      '#', c_brown,  4,  tr_null,
        mfb(transparent)},
{"spiked pit",       '0', c_ltred,  10, tr_spike_pit,
	mfb(transparent)|mfb(diggable)},
{"covered spiked pit",'#', c_ltred,   4, tr_null,
        mfb(transparent)},
...
{"wooden wall",      '#', c_ltred,   0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(noitem)|mfb(support)},
...
{"metal wall",       '|', c_cyan,    0, tr_null,
	mfb(noitem)|mfb(noitem)|mfb(support)},
{"metal wall",       '-', c_cyan,    0, tr_null,
	mfb(noitem)|mfb(noitem)|mfb(support)},
{"glass wall",       '|', c_ltcyan,  0, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(support)},
{"glass wall",       '-', c_ltcyan,  0, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(noitem)|mfb(support)},
...
{"closed wood door", '+', c_brown,   0, tr_null,
	mfb(bashable)|mfb(flammable)|mfb(door)|mfb(noitem)|mfb(support)},
{"damaged wood door",'&', c_brown,   0, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)|
        mfb(support)},
{"open wood door",  '\'', c_brown,   2, tr_null,
	mfb(flammable)|mfb(transparent)|mfb(support)},
...
{"empty window",     '0', c_yellow,  8, tr_null,
	mfb(transparent)|mfb(flammable)|mfb(noitem)|mfb(support)},
...
{"tree",	     '7', c_green,   0, tr_null,
	mfb(flammable)|mfb(noitem)|mfb(support)},
{"young tree",       '1', c_green,   3, tr_null,
	mfb(transparent)|mfb(bashable)|mfb(flammable)|mfb(noitem)},
...
{"wax wall",         '#', c_yellow,  0, tr_null,
	mfb(container)|mfb(flammable)|mfb(noitem)|mfb(support)},
...
{"wheat seedlings",  ';', c_ltgreen,  2, tr_null,
        mfb(transparent)},
{"wheat sprouts",    ';', c_yellow,  2, tr_null,
        mfb(transparent)},
{"wheat",            '"', c_yellow,  2, tr_null,
        mfb(transparent)},
{"potato seedlings", ';', c_ltgreen,  2, tr_null,
        mfb(transparent)},
{"potato sprouts",   ';', c_green,  2, tr_null,
        mfb(transparent)},
{"potatoes",         '"', c_brown,  2, tr_null,
        mfb(transparent)},
...
{"counter",	     '#', c_blue,    4, tr_null,
	mfb(transparent)|mfb(flammable)},
{"armchair",         '#', c_red,   4, tr_null,
        mfb(transparent)|mfb(flammable)},
{"sofa",             '#', c_ltred,   4, tr_null,
        mfb(transparent)|mfb(flammable)},

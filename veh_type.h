...
//                                                                         power type
    ...
    { "2.5L combustion engine",     '*', c_ltred,  '#', c_red,     80, 300, 300, AT_GAS, itm_combustion, 3,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "6L combustion engine",       '*', c_ltred,  '#', c_red,     80, 400, 800, AT_GAS, itm_combustion_large, 3,
        mfb(vpf_internal) | mfb(vpf_engine) },
    ...
    { "large electric motor",       '*', c_yellow,  '#', c_red,    80, 400, 350, AT_BATT, itm_motor_large, 3,
        mfb(vpf_internal) | mfb(vpf_engine) },
    { "plasma engine",              '*', c_ltblue,  '#', c_red,    80, 250, 400, AT_PLASMA, itm_plasma_engine, 4,
        mfb(vpf_internal) | mfb(vpf_engine) },
//                                                                         capacity type
    ...
    { "storage battery",            'O', c_yellow,  '#', c_red,    80, 300, 1000, AT_BATT, itm_storage_battery, 2,
        mfb(vpf_internal) | mfb(vpf_fuel_tank) },
    { "minireactor",                'O', c_ltgreen,  '#', c_red,    80, 700, 10000, AT_PLUT, itm_minireactor, 4,
        mfb(vpf_internal) | mfb(vpf_fuel_tank) },
...
//                                                          bonus
    ...
    { "solar panel", '#', c_yellow,  'x', c_yellow, 10, 20, 30, 0, itm_solar_panel, 4,
    ...
    { "mounted plasma gun", 't', c_ltblue,    '#', c_ltblue,    80, 400, 0, AT_PLASMA, itm_plasma_rifle, 5,
        mfb(vpf_over)  | mfb(vpf_turret) },

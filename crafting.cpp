...
// WEAPONS
 ...
 RECIPE(itm_grenade, CC_WEAPON, sk_mechanics, sk_null, 2, 5000);
  ...
  COMP(itm_nail, 30, itm_bb, 100, itm_shards, 10, NULL);
...
// Survival Craft  1
 ...
 RECIPE(itm_lawnmower_sword, CC_SCRAFT1, sk_mechanics, sk_null, 0, 5000);
  TOOL(itm_duct_tape, 50, NULL);
  COMP(itm_lawnmower_blade, 1, NULL);

 RECIPE(itm_lawnmower_halberd, CC_SCRAFT1, sk_mechanics, sk_null, 1, 5000);
...
// FOOD
 ...
 RECIPE(itm_macaroni_cooked, CC_FOOD, sk_cooking, sk_null, 1, 10000);
  ...
  COMP(itm_water, 1, itm_boiled_water, 1, NULL);
 ...
 RECIPE(itm_boiled_water, CC_FOOD, sk_cooking, sk_null, 0, 5000);
  TOOL(itm_pot, -1, itm_pan, -1, NULL);
 ...
 RECIPE(itm_bread, CC_FOOD, sk_cooking, sk_null, 3, 20000);
  ...
  COMP(itm_water, 2, itm_boiled_water, 2, NULL);
...
//TODO: Add most of the disassembly recipes to the iuse of the screwdriver and wrench
 RECIPE(itm_antenna, CC_ELECTRONIC, sk_null, sk_null, 0, 3000);
  TOOL(itm_hacksaw, -1, itm_toolset, -1, NULL);
  COMP(itm_motor, 1, itm_knife_butter, 2,
       NULL);

 RECIPE(itm_amplifier, CC_ELECTRONIC, sk_electronics, sk_null, 1, 4000);
  TOOL(itm_screwdriver, -1, itm_toolset, -1, NULL);
  COMP( itm_transponder, 2, itm_flashlight, 1, NULL);

...
void game::init_mapitems()
{
 ...
 setvector(
   mapitems[mi_home_hw],
	...
	itm_bubblewrap, itm_binoculars, itm_lawnmower, itm_duct_tape, NULL);
 ...
 setvector(
   mapitems[mi_hardware],
	...
	itm_pipe, itm_nail, itm_hose, itm_string_36, itm_frame, itm_metal_tank, 
        itm_lawnmower, itm_duct_tape, NULL);
 ...
 setvector(
   mapitems[mi_wood_working_tools],
        ...
        itm_screwdriver, itm_glasses_safety, itm_hat_hard, itm_pipe, itm_textbook_carpentry, itm_2x4,
        NULL);
 ...
 setvector(
   mapitems[mi_mil_surplus], // NOT food or armor!
	...
	itm_geiger_off, itm_usb_drive, itm_e_tool_c, itm_cot, itm_rollmat,
        itm_glowstick, itm_flare, NULL);
 ...
 setvector(
   mapitems[mi_shelter],
	...
	itm_flashlight, itm_hotplate, itm_water_purifier, itm_radio,
        itm_rope_30, itm_rollmat, itm_glowstick, NULL);
 ...
 setvector(
   mapitems[mi_survival_tools],
	...
	itm_grenade, itm_EMPbomb, itm_hotplate, itm_UPS_off, itm_rollmat,
        itm_cot, itm_glowstick, itm_flare, NULL);
 ...
 setvector(
   mapitems[mi_mine_storage],
	itm_rock, itm_coal, itm_flare, NULL);
 ...
 setvector(
   mapitems[mi_mine_equipment],
	...
	itm_bionics_construction, itm_flare, itm_glowstick, NULL);
 ...
 setvector(
   mapitems[mi_sewer],
	itm_mutagen, itm_fetus, itm_weed, itm_mag_porn, itm_rag, itm_glowstick, NULL);

 setvector(
   mapitems[mi_cavern],
	itm_rock, itm_jackhammer, itm_flashlight, itm_dynamite, itm_flare, NULL);
 ...
 setvector(
   mapitems[mi_trader_avoid],
	...
	itm_dynamite_act, itm_mininuke_act, itm_UPS_on, itm_mp3_on, itm_c4armed,
        itm_forge, itm_crucible_fake, itm_anvil_fake, itm_potatoseeds, itm_wheatseeds,
	NULL);
}
